...
using AuthorRole = Microsoft.SemanticKernel.AI.ChatCompletion.AuthorRole;
...
namespace SemanticKernelExamples
{
    ...
    public class ChatSkill
    {
        ...
        public ChatSkill(IKernel kernel)
        {
            ...
            this._chatHistory = this._chatCompletion.CreateNewChat("You are a friendly, intelligent, and curious assistant who is good at conversation.");
        }

...
public class Example13_ConversationSummarySkill
{
    public static async Task Run(bool internet = false)
    {
        ...
        else
        {
            ...
            Console.WriteLine("Fails with CUDA: https://github.com/SciSharp/LLamaSharp/issues/31");
        ...
        await ConversationSummarySkillAsync(kernel);
        await GetConversationActionItemsAsync(kernel);
        await GetConversationTopicsAsync(kernel);
    }

    private static async Task GetConversationActionItemsAsync(IKernel kernel)
    {
    ...
    private static async Task GetConversationTopicsAsync(IKernel kernel)
    {
    ...
    private static async Task ConversationSummarySkillAsync(IKernel kernel)
    {
